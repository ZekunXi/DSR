...
- Each step selects one transition (t1..t4) randomly and tries to fire it.
- Current limitation: duplicate outputs and invalid transition attempts are NOT filtered yet.

DE:
- Einfache Petri-Netz-Simulation mit zufälliger Transitionsauswahl.
